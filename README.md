...
| <a name="input_dnssec"></a> [dnssec](#input\_dnssec) | Configuration for Route53 DNSSEC | <pre>object({<br/>    zone_id                 = optional(string)<br/>    kms_key_arn             = optional(string)<br/>    kms_key_alias           = optional(string)<br/>    kms_key_deletion_window = optional(number, 7)<br/>    ksk_name                = string<br/>    signing_status          = optional(string, "SIGNING")<br/>    tags                    = optional(map(string))<br/>  })</pre> | `null` | no |
