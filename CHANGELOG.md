...
### [5.1.0](https://github.com/plus3it/terraform-aws-tardigrade-route53-subzone/releases/tag/5.1.0)

**Released**: 2026.03.18

**Summary**:

*   Adds new DNSSEC submodule with KMS config

### [5.0.0](https://github.com/plus3it/terraform-aws-tardigrade-route53-subzone/releases/tag/5.0.0)
